...
- Тестирование производилось на наборе массивов big_tests
### График 
![резы тестов](./practicum_work2/results/3_results/merge_sort.png)
...
### График 
![резы тестов](./practicum_work2/results/4_results/qsort.png)
---
![резы тестов](./practicum_work2/results/4_results/dublicates_qsort.png)
...
- Тестирование производилось на наборе массивов big_tests
### График 
![резы тестов](./practicum_work2/results/5_results/pivot_qsort.png)
###  Какой вариант работает лучше?
...
### График 
![резы тестов](./practicum_work2/results/6_results/pivot_qsort.png)
###  Какой вариант работает лучше?
Наиболее быстрым является выбор центрального элемента, это свзяано с тем, что мы высчитываем центральный индекс и по нему обращаемся к $pivot$,
а в слуае медианы нам необходимо обратить к функции поиска медианы и найти ее, что также занимает время, в слчае рандомного центрального элемента 
поиск рандомного также затрачивает время.  
...
- Тестирование производилось на наборе массивов big_tests
### График 
![резы тестов](./practicum_work2/results/8_results/msd_lsd_sort.png)
###  Какая сортировка работает лучше?
Сортировка LSD работет быстрее, так как в ней, в отличии от MSD, не имеет рекурсии.
## Вывод
